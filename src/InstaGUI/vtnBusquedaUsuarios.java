...
public class vtnBusquedaUsuarios extends JDialog{
    ...
    public vtnBusquedaUsuarios(Usuario usuario, vtnInstaPrincipal vtnP) {
        ...
        if (texto.isEmpty()) {
            ...
            if (resultados.isEmpty()) {
                ...
                for (Usuario u : resultados) {
                    panelResultados.add(new ResultadoBusqueda(u, vtnP, this)); // Usamos el Componente
                }
            }
        }
    ...
    private void ejecutarBusqueda() {
        ...
        if (texto.isEmpty()) {
            ...
            if (resultados.isEmpty()) {
                ...
                for (Usuario u : resultados) {
                    // Creamos el panel de vista previa para cada resultado
                    JPanel panelPrevio = crearPanelUsuarioResultado(u);
    ...
    private void actualizarBotonFollow(JButton btnFollow, String usernameObjetivo) {
        ...
        if (siguiendo) {
            ...
            btnFollow.setBackground(new Color(0, 150, 255)); // Azul
